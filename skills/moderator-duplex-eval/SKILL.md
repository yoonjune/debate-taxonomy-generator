...
| A3-1 | open the crossfire | both openings done | end of CON opening | [end, end+2] | moving on to the next phase (any wording) **and** the length (two and a half minutes) |
...
| B2 | point out a self-contradiction | a speaker breaks an absolute rule they stated earlier | end of the second claim | [end, end+2] | points out the self-contradiction **and** asks them to reconcile |
